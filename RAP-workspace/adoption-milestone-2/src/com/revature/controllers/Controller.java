		...
		while (isRunning) {
			...
			switch (choice1) {
				case 1: // call login service layer function
						...
						user = new Customer("customer1", "pass", "Geoffrey Webber");
//							user = new Employee("employee1", "pass");
				...
				case 3: isRunning = false;
						...
						break;
				default: System.out.print(" Please enter a number from 1-3.\n");
						break;
			}
			...
			// if user is a customer
				...
				while (isCustomer) {
					...
					case 2: // make service call to view current offers
							...
							break;
					case 3: // make service call to view current funds
							break;
					case 4: user = null;
							isCustomer = false;
							break;
	...
	public static int displayLoginMenu() {
		...
		// exception handling: use nextLine to include newline character,
		// then try to parse into int
		try {
